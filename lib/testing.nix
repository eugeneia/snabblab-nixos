...
rec {
  ...
  PCIAssignments = {
    ...
    dyser = {
      SNABB_PCI0 = "22:00.0";
      SNABB_PCI1 = "22:00.0";
      SNABB_PCI_INTEL1G0 = "22:00.0";
      SNABB_PCI_INTEL1G1 = "23:00.2";
    };
  };
  ...
  mkSnabbTest = { name # name of the test executed
    ...
    pkgs.stdenv.mkDerivation ((getPCIVars hardware) // {
      ...
      buildInputs = [ pkgs.git pkgs.telnet pkgs.tmux pkgs.numactl pkgs.bc
                      pkgs.iproute pkgs.which qemu pkgs.utillinux pkgs.kmod ];
